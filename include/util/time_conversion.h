...
// converts GPS timestamp to/from UNIX system timestamp.

// Taken from Apollo codebase.

#ifndef DRIVERS_GNSS_TIME_CONVERSION_H
#define DRIVERS_GNSS_TIME_CONVERSION_H
...
#endif // DRIVERS_GNSS_TIME_CONVERSION_H
